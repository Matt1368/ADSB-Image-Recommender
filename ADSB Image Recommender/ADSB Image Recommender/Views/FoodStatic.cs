...
{
    public class FoodStatic : ContentPage
    {
        public FoodStatic(int num)
        {
            ...
            Image img1 = new Image { Source = "burrito.png" };
            ...
            if (num >= 2)
            {
                img2.Source = "biryani.png";
            }
            if (num >= 3)
            {
                img3.Source = "pancake.png";
            }
            if (num >= 4)
            {
                img4.Source = "hamburger.png";
            }
