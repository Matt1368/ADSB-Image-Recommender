...
{
    public class FoodGIF : ContentPage
    {
        public FoodGIF(int num)
        {
            ...
            Image img1 = new Image { Source = "pizzaGIF.gif", IsAnimationPlaying = true };
            ...
            if (num >= 2)
            {
                img2.Source = "spaghettiGIF.gif";
                img2.IsAnimationPlaying = true;
            }
            if (num >= 3)
            {
                img3.Source = "steakGIF.gif";
                img3.IsAnimationPlaying = true;
            }
            if (num >= 4)
            {
                img4.Source = "lobsterGIF.gif";
