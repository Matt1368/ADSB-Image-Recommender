...
{
    public class NatureStatic : ContentPage
    {
        public NatureStatic(int num)
        {
            ...
            Image img1 = new Image { Source = "forrest.png" };
            ...
            if (num >= 2)
            {
                img2.Source = "snowcap.png";
            }
            if (num >= 3)
            {
                img3.Source = "beach.png";
            }
            if (num >= 4)
            {
                img4.Source = "desert.png";
            }
