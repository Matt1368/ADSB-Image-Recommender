...
{
    public class NatureGIF : ContentPage
    {
        public NatureGIF(int num)
        {
            ...
            Image img1 = new Image { Source = "forrestGIF.gif", IsAnimationPlaying = true };
            ...
            if (num >= 2)
            {
                img2.Source = "riverGIF.gif";
                img2.IsAnimationPlaying = true;
            }
            if (num >= 3)
            {
                img3.Source = "plantGIF.gif";
                img3.IsAnimationPlaying = true;
            }
            if (num >= 4)
            {
                img4.Source = "starsGIF.gif";
