...
{
    public class AnimalGIF : ContentPage
    {
        public AnimalGIF(int num)
        {
            ...
            Image img1 = new Image { Source = "bearGIF.gif", IsAnimationPlaying = true };
            ...
            if (num >= 2)
            {
                img2.Source = "birdGIF.gif";
                img2.IsAnimationPlaying = true;
            }
            if (num >= 3)
            {
                img3.Source = "dogGIF.gif";
                img3.IsAnimationPlaying = true;
            }
            if (num >= 4)
            {
                img4.Source = "cowGIF.gif";
